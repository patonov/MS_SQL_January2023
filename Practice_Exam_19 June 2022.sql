...
SELECT 
	...
	AnimalId,	
	DepartmentId
FROM Volunteers ORDER BY [Name] ASC, AnimalId ASC, DepartmentId ASC
...
JOIN AnimalTypes AS aty ON a.AnimalTypeId = aty.Id
WHERE a.OwnerId IS NULL AND DATEDIFF(YEAR, CAST(a.BirthDate AS varchar), '2022-01-01') < 5 AND a.AnimalTypeId != 3
ORDER BY a.[Name]
